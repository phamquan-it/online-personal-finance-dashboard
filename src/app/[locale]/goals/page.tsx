                ...
                >
                  ...
                  activeForm.goalId === goal.id ? (
                    ...
                    <Form
                      layout="vertical"
                      onFinish={(values) => {
                        console.log('Add saving:', values)
                        // TODO: Call add saving mutation
                        messageApi.success('Saving added!')
                        handleCancelActiveForm()
                      }}
                    >
                      <Form.Item
                        label="Saving Amount"
                    ...
                    <>
                      ...
                      <Text>
                        {t('goalSavedAmount')}:{' '}
                        <strong>{goal.savedAmount.toLocaleString()} VND</strong> /{' '}
                        <strong>{goal.targetAmount.toLocaleString()} VND</strong>
                      </Text>
                      <br />
                      <Text type="secondary">
                        {t('goalDeadline')}: {deadline.format('DD/MM/YYYY')} (
                        {timeLeft})
                      </Text>
                    </>
                  )}
