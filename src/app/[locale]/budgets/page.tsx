...
import { AlertOutlined, DeleteOutlined, EditOutlined, EllipsisOutlined, PlusOutlined } from '@ant-design/icons'
                    ...
                    budgets.map((budget: BudgetType) => {
                        ...
                        return (
                            <Col xs={24} md={12} lg={8} key={budget.id}>
                                <Card
                                    title={`${budget.category} (${budget.frequency === 'monthly'
                                        ? t('budgetMonthly')
                                ...
                                >
                                    ...
                                    {editingBudgetId === budget.id ? (
                                        // 🟢 Hiển thị Form khi đang chỉnh sửa Card này
                                        <Form
                                            layout="vertical"
                                            initialValues={budget}
                                            onFinish={async (values) => {
                                                console.log('Update values:', values);
                                                // TODO: Gọi mutation updateBudget ở đây
